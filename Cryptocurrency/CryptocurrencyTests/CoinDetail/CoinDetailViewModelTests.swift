...
final class CoinDetailViewModelTests: XCTestCase {
  ...
  override func setUp() {
    let tickerResponseStub: Result<AllTickerResponse, APINetworkError> = .success(AllTickerResponse(
      status: "0000",
      data: [
        "BTC": TickerData(
          openingPrice: "1000",
    ...
    let candleStickResponseStub: Result<CandleStickResponse, APINetworkError> = .success(CandleStickResponse(
      status: "0000",
      data: [
        [
